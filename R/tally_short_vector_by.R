#' Vector Tally of Short-Syllabic Words By Grouping Variable(s)
#'
#' Short-syllabic (< 3 syllables) word tallies for the words in a vector of
...
#'    group = c("A", "B", "A")
#' )
#' tally_short_vector_by(dat$text, dat$group)
#'
